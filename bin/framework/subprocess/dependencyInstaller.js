...
const install = () => {
    return new Promise((resolve, reject) => {
        const installCommand = 'npm install express cors dotenv mysql2 multer cloudinary multer-storage-cloudinary nodemailer express-rate-limit node-fpgrowth node-fetch bcrypt ml-regression express-session jsonwebtoken cookie-parser serve express-mysql-session  --save-dev nodemon';
